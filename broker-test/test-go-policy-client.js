...
const operation = {
  identity: {
    ...
    context: {
      ...
      approvalGrants: [
        { provider: 'github', operation_id: 'repo.read', account_ref: 'primary', environment: 'production', resource_ref: 'tyj1987/broker', approved_by: 'alice', expires_at_ms: Date.now() + 60_000 },
        { provider: 'github', operation_id: 'repo.read', account_ref: 'primary', environment: 'production', resource_ref: 'tyj1987/broker', approved_by: 'bob', expires_at_ms: Date.now() + 60_000 },
      ],
    },
  },
...
const sparseOperation = {
  ...
  identity: {
    ...
    context: {
      ...
      approvalGrants: [
        null,
        { provider: 'other', operation_id: 'repo.read', account_ref: 'primary', environment: 'production', resource_ref: 'tyj1987/broker', approved_by: 'alice', expires_at_ms: Date.now() + 60_000 },
