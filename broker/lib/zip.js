// broker/lib/zip.js — minimal store-only ZIP writer (no compression, zero deps)
// Used for client cert bundles. Extracted from server.js in Phase B.
...
/**
 * Build an uncompressed ZIP from { name, data } entries.
